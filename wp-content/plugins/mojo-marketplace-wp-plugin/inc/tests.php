...
function mm_jetpack_start_test() {
	...
	if ( file_exists( $file ) && mm_jetpack_bluehost_only() ) {
		if ( ! mm_ab_test_inclusion( 'jetpack-start-v11', md5( 'jetpack-start-v11' ), 25, WEEK_IN_SECONDS * 4 ) ) {
			mm_ab_test_inclusion( 'jetpack-start-exempt-v11', md5( 'jetpack-start-exempt-v11' ), 33, WEEK_IN_SECONDS * 4 );
