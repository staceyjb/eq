		...
		<div class="cat-container">	
	    	<div class="cat-head mbottom">
					<h1 class="archive-title">
						<?php _e("Search Results For:", "wiles"); ?> <?php echo get_search_query(); ?>
					</h1>
			...
			<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				...
				<article class="item-list mbottom">
			        ...
			        <div class="cdetail">		
			            <h3><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h3>
                            ...
                            <div class="postmeta">
			           		    <p class="vsmall pnone"><?php _e('By', 'wiles'); ?> <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) )?>" title="<?php sprintf( esc_attr__( 'View all posts by %s', 'wiles' ), get_the_author() ) ?>"><?php echo get_the_author() ?> </a>
				...
				<?php endwhile; ?>
				    <div class="pagenavi alignright">
					    <?php if ($wp_query->max_num_pages > 1) wiles_get_pagenavi(); ?>
					</div>
